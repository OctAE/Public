...
$(document).ready(function(){
	...
	if (pathname == "/crest/confirm-my-details") {
	          $( ".stepsHighlight" ).addClass('noAfter');
	        }
...
*/
    ...
    $('.invoiceback').after('<p id="afterCompleteMsg">Click <a href="/crest/products">Open Catalogue</a> to place another order, or <a href="/crest/logout">Log Out</p>');
    ...
    if (pathname.indexOf('product-edit') > -1 || pathname.indexOf('kit-edit') > -1 ) {
    	...
    	if ($('a#addToKit span:contains(kit)').length == 0) {
		        ...
		        var breadcrumbHtml = "<div style='padding: 10px 0px 30px 4px; display: block'><strong>You are at: > > <a href='/crest/products'>Crest</a>"
		       	var pathArray = pathname.split("/");
		        var pathBefore = "";
		    		for (i = 2; i < pathArray.length-1; i++) {
		   				 pathBefore = pathBefore + "/" + pathArray[i]; 
		           		 breadcrumbHtml = breadcrumbHtml + " > <a href='/crest/products" + pathBefore + "'>" + pathArray[i] + "</a>";
					}
