...
$(document).ready(function(){
	...
	$( "#companyName").replaceWith("<select style='width:204px;' name='companyName' id='companyName'><option>Taylor Wimpey Bristol</option><option>Taylor Wimpey Central London</option><option>Taylor Wimpey East Anglia</option><option>Taylor Wimpey East London</option><option>Taylor Wimpey East Midlands</option><option>Taylor Wimpey East Scotland</option><option>Taylor Wimpey Exeter</option><option>Taylor Wimpey Manchester</option><option>Taylor Wimpey Midlands</option><option>Taylor Wimpey North East</option><option>Taylor Wimpey North Midlands</option><option>Taylor Wimpey North Thames</option><option>Taylor Wimpey North West</option><option>Taylor Wimpey North Yorkshire</option><option>Taylor Wimpey Oxfordshire</option><option>Taylor Wimpey South East</option><option>Taylor Wimpey South Midlands</option><option>Taylor Wimpey South Wales</option><option>Taylor Wimpey South West Thames</option><option>Taylor Wimpey Southern Counties</option><option>Taylor Wimpey West London</option><option>Taylor Wimpey West Midlands</option><option>Taylor Wimpey West Scotland</option><option>Taylor Wimpey Yorkshire</option>");
