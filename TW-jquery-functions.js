...
$(document).ready(function(){
	...
	$('span:contains("[Complete Order]")').html('Send Sales Order Request');



	if (pathname.indexOf('edit-my-details') > -1){
		var companyName = $('#companyName').val();
		$( "#companyName").replaceWith("<select style='width:204px;' name='companyName' id='companyName'><option value='Taylor Wimpey Bristol'>Taylor Wimpey Bristol</option><option value='Taylor Wimpey Central London'>Taylor Wimpey Central London</option><option value='Taylor Wimpey East Anglia'>Taylor Wimpey East Anglia</option><option value='Taylor Wimpey East London'>Taylor Wimpey East London</option><option value='Taylor Wimpey East Midland'>Taylor Wimpey East Midlands</option><option value='Taylor Wimpey East Scotland'>Taylor Wimpey East Scotland</option><option value='Taylor Wimpey Exeter'>Taylor Wimpey Exeter</option><option value='Taylor Wimpey Manchester'>Taylor Wimpey Manchester</option><option value='Taylor Wimpey Midlands'>Taylor Wimpey Midlands</option><option value='Taylor Wimpey North East'>Taylor Wimpey North East</option><option value='Taylor Wimpey North Midlands'>Taylor Wimpey North Midlands</option><option value='Taylor Wimpey North Thames'>Taylor Wimpey North Thames</option><option value='Taylor Wimpey North West'>Taylor Wimpey North West</option><option value='Taylor Wimpey North Yorkshire'>Taylor Wimpey North Yorkshire</option><option value='Taylor Wimpey Oxfordshire'>Taylor Wimpey Oxfordshire</option><option value='Taylor Wimpey South East'>Taylor Wimpey South East</option><option value='Taylor Wimpey South Midlands'>Taylor Wimpey South Midlands</option><option value='Taylor Wimpey South Wales'>Taylor Wimpey South Wales</option><option value='Taylor Wimpey South West Thames'>Taylor Wimpey South West Thames</option><option value='Taylor Wimpey Southern Counties'>Taylor Wimpey Southern Counties</option><option value='Taylor Wimpey West London'>Taylor Wimpey West London</option><option value='Taylor Wimpey West Midlands'>Taylor Wimpey West Midlands</option><option value='Taylor Wimpey West Scotland'>Taylor Wimpey West Scotland</option><option value='Taylor Wimpey Yorkshire'>Taylor Wimpey Yorkshire</option>");
		$("#companyName option[value='"+ companyName +"']").attr("selected","selected");
  ...
  .change(function () {
    ...
    $( "input#companyName" ).val( costcode );
  })
  .change();*/
	}
...
//********************STEPS**********************//
   ...
   if((pathname.indexOf('order-history') > -1) || (pathname.indexOf('order_login_srch_nmdet'))) {
		...
		$('strong:contains("Invoice No.")').each(function( index ) {
 			...
 			$('#filemakerOrderHistory').append('<tr><td><a class="filemakerWebOrderLink" href="http://server.octink.com/taylorwimpey/project.php?weborder=' + webOrderNumber + '" target="_blank">Web Order Number: <span style="font-weight: bold; color: ##1a64a1">' + webOrderNumber + '</span></a></td></tr>');
		});
...
//Change â€œEdit my detailsâ€ button text to â€œChange â€œdelivery addressâ€
    ...
    if (pathname.indexOf('product-edit') > -1 || pathname.indexOf('kit-edit') > -1 ) {
    	...
    	if ($('a#addToKit span:contains(kit)').length == 0) {
		        ...
		        var breadcrumbHtml = "<div style='padding: 10px 0px 30px 4px; display: block'><strong>Current order status: > > <a href='/taylorwimpey/products'>Tylor Wimpey</a>"
