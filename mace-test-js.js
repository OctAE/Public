...
if (pathname.indexOf('basket') > -1){
	...
	$( "select[name='costcode']" )
	  .change(function () {
	    ...
	    $( "input#ponumber" ).val(":codecost:" + costcode + ":costcodeclose:" + ":projectcode:" + projectcode + ":projectcodeclose:" );
	  })
	  .change();
